    ...
    <div className="text-gray-900">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              {photoURL && (
                <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-100 border-2 border-blue-500">
          ...
          {photoURL && (
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-sm text-gray-600">Profile photo preview</span>
            </div>
          )}
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 font-semibold"
            >
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          {passwordMessage && (
            <div className={`mb-4 p-3 rounded-lg ${passwordMessage.includes("✅") ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
              {passwordMessage}
            </div>
          )}
          ...
          {showPasswordForm && (
            <form onSubmit={handlePasswordChange} className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 disabled:opacity-50 font-semibold"
              >
