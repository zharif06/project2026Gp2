...
export default function UsersManagement({ users, currentUser, onRefresh }: UsersManagementProps) {
  ...
  const getRoleBadge = (role: string) => {
    ...
    return (
      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${styles[safeRole] || styles.user}`}>
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage users, assign roles, and control access</p>
        </div>
        <div className="flex gap-3">
          <button 
            onClick={() => setShowInstructions(true)} 
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl hover:shadow-lg transition-all"
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-800">How to Add Staff Member</h3>
              <button 
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Click the "Open Firebase Console" button</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Go to Authentication → Users</p>
                    <p className="text-sm text-gray-500">Click "Add user" and enter email and password</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Copy the User UID</p>
                    <p className="text-sm text-gray-500">After creating, copy the long User UID string</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Go to Firestore → users collection</p>
                    <p className="text-sm text-gray-500">Click "Add document"</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Set Document ID as the User UID</p>
                    <p className="text-sm text-gray-500">Paste the UID as the document ID</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="bg-orange-500 text-white w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">6</span>
                  <div>
                    <p className="font-medium">Add the following fields:</p>
                    <div className="bg-gray-100 p-3 rounded-lg mt-2 text-sm font-mono">
                ...
                <div className="flex items-start gap-3">
                  <span className="bg-orange-500 text-white w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">7</span>
                  <div>
                    <p className="font-medium">Click Save</p>
                    <p className="text-sm text-gray-500">The staff member will appear in the list above</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-4 p-3 bg-yellow-50 rounded-lg">
                <p className="text-sm text-yellow-800">💡 Tip: Open Firebase Console in a new tab so you can follow these steps while keeping your admin panel open.</p>
              </div>
              
              <button
                onClick={() => setShowInstructions(false)}
                className="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 font-semibold mt-2"
              >
                Got it
              </button>
            </div>
